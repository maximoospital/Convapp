...
const List<String> tipotime = <String>['Y', 'Mth', 'W', 'D', 'H', 'M', 'S'];
...
class timestate extends State<time> {
  String _dropDownValue = 'H';
  String _dropDownValue2 = 'S';
  double inputValue = 0;
  ...
  outputFunc(inputVal) {
    switch(_dropDownValue) {
      case 'S':
        print('m!');
        setState((){
          valorSec = double.parse(inputVal);
        });
        break;
      case 'M':
        setState((){
          valorSec = double.parse(inputVal) * 60;
        });
        break;
      case 'H':
        setState((){
          valorSec = double.parse(inputVal) * 3600;
        });
        break;
      case 'D':
        setState((){
          valorSec = double.parse(inputVal) * 86400;
        });
        break;
      case 'W':
        setState((){
          valorSec = double.parse(inputVal) * 604800;
        });
        break;
      case 'Mth':
        setState((){
          valorSec = double.parse(inputVal) * 2629800;
        });
        break;
      case 'Y':
        setState((){
          valorSec = double.parse(inputVal) * 31556952;
        });
        break;
        break;
      default:
    ...
    switch(_dropDownValue2) {
      case 'S':
        print('m!');
        setState((){
          outputValue = valorSec;
        });
        break;
      case 'M':
        setState((){
          outputValue = valorSec / 60;
        });
        break;
      case 'H':
        setState((){
          outputValue = valorSec / 3600;
        });
        break;
      case 'D':
        setState((){
          outputValue = valorSec / 86400;
        });
        break;
      case 'W':
        setState((){
          outputValue = valorSec / 604800;
        });
        break;
      case 'Mth':
        setState((){
          outputValue = valorSec / 2629800;
        });
        break;
      case 'Y':
        setState((){
          outputValue = valorSec / 31556952;
        });
        break;
      default:
        print('error');
      ...
      children: <Widget>[
        ...
        Container(
            ...
            child: DropdownButton<String>(
              ...
              items: tipotime.map<DropdownMenuItem<String>>((String value) {
